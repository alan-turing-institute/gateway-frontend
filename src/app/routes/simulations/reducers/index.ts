...
/**
 * Just like with the cases selectors, we also have to compose the search
...
export const getCollectionState = createSelector(
  getCasesState,
  (state: CasesState) => state.collection
);
...
export const getCollectionCaseIds = createSelector(
  getCollectionState,
  fromCollection.getIds
);

// export const getCaseCollection = createSelector(
//   getCaseEntities,
//   getCollectionCaseIds,
//   (entities, ids) => {
//     return ids.map(id => entities[id]);
//   }
// );
//
// export const isSelectedCaseInCollection = createSelector(
//   getCollectionCaseIds,
//   getSelectedCaseId,
//   (ids, selected) => {
